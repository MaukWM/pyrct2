...
# Generated: 2026-04-20T14:59:56.878131+00:00
#
...
class FootpathLayoutPlaceParams(_ActionParams):
    ...
    y: int
    z: int
    slope_type: FootpathSlopeType
    slope_direction: Direction
    object: int
    railings_object: int
    edges: int
    construct_flags: PathConstructFlags
...
class LoadOrQuitParams(_ActionParams):
    mode: LoadOrQuitModes
    save_prompt_mode: PromptMode
...
class ParkSetParameterParams(_ActionParams):
    parameter: ParkParameter
    value: int

class ParkSetResearchFundingParams(_ActionParams):
    priorities: int
    funding_amount: ResearchFundingLevel
...
class RideCreateParams(_ActionParams):
    ...
    colour1: int
    colour2: int
    inspection_interval: RideInspection

class RideDemolishParams(_ActionParams):
    ride: int
    modify_type: RideModifyType
...
class RideSetVehicleParams(_ActionParams):
    ride: int
    type: RideSetVehicleType
    value: int
    colour: int

class ScenarioSetSettingParams(_ActionParams):
    setting: ScenarioSetSetting
    value: int
...
class TrackPlaceParams(_ActionParams):
    ...
    colour: int
    seat_rotation: int
    track_place_flags: SelectedLiftAndInverted
